...
To use these stylesheets, rename the files and andesbdc with the name of your theme.
...
andesbdc-alpha-default-narrow.css  
...
andesbdc-alpha-default-normal.css
...
andesbdc-alpha-default-wide.css
