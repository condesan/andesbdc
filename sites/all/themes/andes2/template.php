 ...
 *   entirety and paste it here, changing the prefix from theme_ to andes2_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: andes2_breadcrumb()
 *
 ...
 */
function andes2_theme(&$existing, $type, $theme, $path) {
...
function andes2_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function andes2_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function andes2_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
