...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  ...
  <div class="content">
   ...
   if ($block->delta == 'menu-icons') {
     $items =  menu_navigation_links($block->delta);
     foreach($items as $k => $v) {
       $menus[$k]['attributes']['class'] = $v['title'];
       $menus[$k]['attributes']['title'] = $v['title'];
       $menus[$k]['href'] = $v['href'];
       $menus[$k]['title'] = $v['title'];
     }
    $output = theme('links', $menus);
   }      
   else {
   $output = $content;
   }
